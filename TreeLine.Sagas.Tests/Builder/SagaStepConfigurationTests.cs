...
namespace TreeLine.Sagas.Tests.Builder
{
    public class SagaStepConfigurationTests
    {
        ...
        {
            // Assert
            Assert.Throws<ArgumentNullException>(() => new SagaStepConfiguration<SagaEvent01, SagaStep01Mock>(null, null));
        }
        ...
        {
            // Arrange
            var sagaStepConfiguration = new SagaStepConfiguration<SagaEvent01, SagaStep01Mock>("1", null);
        ...
        {
            // Arrange
            var sagaStepConfiguration = new SagaStepConfiguration<SagaEvent01, SagaStep01Mock>("1", _ => false);
            var sagaEvent = new SagaEvent01();
        ...
        {
            // Arrange
            var sagaStepConfiguration = new SagaStepConfiguration<SagaEvent01, SagaStep01Mock>("1", _ => true);
            var sagaEvent = new SagaEvent02();
